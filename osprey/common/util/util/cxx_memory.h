...
#ifdef __GNUC__
BE_EXPORTED void* operator new (size_t sz) throw(std::bad_alloc);
BE_EXPORTED void * operator new[] (size_t sz) throw(std::bad_alloc);
BE_EXPORTED void operator delete (void* ptr) throw();
BE_EXPORTED void operator delete[] (void* ptr) throw();
#else
BE_EXPORTED void* operator new (size_t sz);
BE_EXPORTED void * operator new[] (size_t sz);
BE_EXPORTED void operator delete (void* ptr);
BE_EXPORTED void operator delete[] (void* ptr);
#endif /* __GNUC__ */

BE_EXPORTED extern MEM_POOL* Delete_Mem_Pool;

BE_EXPORTED extern MEM_POOL* _dummy_new_mempool;
BE_EXPORTED extern MEM_POOL* _dummy_delete_mempool;

#ifdef Is_True_On
BE_EXPORTED extern int          _alloc_callsite_line;
BE_EXPORTED extern const char * _alloc_callsite_file;
#endif

BE_EXPORTED extern size_t _dummy_pad;
