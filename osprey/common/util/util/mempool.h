 ...
 */
BE_EXPORTED extern MEM_POOL MEM_local_pool;
BE_EXPORTED extern MEM_POOL MEM_src_pool;
BE_EXPORTED extern MEM_POOL MEM_pu_pool;
BE_EXPORTED extern MEM_POOL MEM_phase_pool;

BE_EXPORTED extern MEM_POOL *MEM_local_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_src_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_pu_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_phase_pool_ptr;
 ...
 * appropriate.
 */
BE_EXPORTED extern MEM_POOL MEM_local_nz_pool;
BE_EXPORTED extern MEM_POOL MEM_src_nz_pool;
BE_EXPORTED extern MEM_POOL MEM_pu_nz_pool;
BE_EXPORTED extern MEM_POOL MEM_phase_nz_pool;

BE_EXPORTED extern MEM_POOL *MEM_local_nz_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_src_nz_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_pu_nz_pool_ptr;
BE_EXPORTED extern MEM_POOL *MEM_phase_nz_pool_ptr;

BE_EXPORTED extern void MEM_Trace(void);
...
BE_EXPORTED extern void MEM_Tracing_Enable(void);

BE_EXPORTED extern MEM_PTR
MEM_POOL_Alloc_P
(
  MEM_POOL *mempool,
  size_t    size
...
BE_EXPORTED extern void MEM_POOL_Set_Default(MEM_POOL *pool);
BE_EXPORTED extern void MEM_POOL_FREE(MEM_POOL *pool, void *data);
BE_EXPORTED extern void MEM_POOL_Delete(MEM_POOL *pool);
...
public:
  ...
  CXX_MEM_POOL(char *name, BOOL bz) {
    mem_pool.magic_num = 0;		/* force it to be uninitialized */
    MEM_POOL_Initialize(&mem_pool, name, bz);
