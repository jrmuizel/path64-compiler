...
CG_EXPORTED extern BS *BS_Create_Empty( BS_ELT size, MEM_POOL *pool );
...
CG_EXPORTED extern BS_ELT BS_Choose( const BS *bs );
...
CG_EXPORTED extern BS_ELT BS_Size( BS *set );
...
extern BS* BS_UnionD_Intersection( BS* set1, BS* set2, BS* set3,
                                   MEM_POOL *pool );
CG_EXPORTED extern BS *BS_Union1D( BS *set, BS_ELT x, MEM_POOL *pool );
...
CG_EXPORTED extern BOOL BS_MemberP( BS *set, BS_ELT x );
extern BOOL BS_Intersection_MemberP( BS *set1, BS *set2, BS_ELT x );
CG_EXPORTED extern BS_ELT BS_Choose_Next( const BS *set, BS_ELT elt);
