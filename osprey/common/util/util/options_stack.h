...
class BE_EXPORTED_CLASS OPTIONS_STACK {
 private:
  BOOL _trace;
 ...
 public:
  ...
  BE_EXPORTED_METHOD void Init(void) {
  ...
  BE_EXPORTED_METHOD void Push_Current_Options(void);
  BE_EXPORTED_METHOD void Pop_Current_Options(void);

  // Process pragma options
  BE_EXPORTED_METHOD void Process_Pragma_Options(char *);
};
