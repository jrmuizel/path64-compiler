...
BE_EXPORTED extern vstring vstr_begin (int len);
BE_EXPORTED extern void vstr_end (vstring v);

/* add char to vstring */
BE_EXPORTED extern vstring vstr_append (vstring v, const char c);

/* add string to vstring */
BE_EXPORTED extern vstring vstr_concat (vstring v, const char *s);

/* sprintf that reallocs space if needed */
BE_EXPORTED extern int vstr_sprintf (vstring *v, int index, const char *format, ... /* args */);
