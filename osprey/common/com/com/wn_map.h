...
BE_EXPORTED extern WN_MAP_TAB *Current_Map_Tab;


BE_EXPORTED extern WN_MAP_TAB *WN_MAP_TAB_Create(
    struct mem_pool *pool
);

BE_EXPORTED extern void WN_MAP_TAB_Delete(
    WN_MAP_TAB	*maptab
);
...
BE_EXPORTED extern WN_MAP WN_MAP_Do_Create(
    WN_MAP_TAB  *maptab,
    struct mem_pool *pool,
    WN_MAP_KIND kind
);
...
BE_EXPORTED extern WN_MAP_ID IPA_WN_MAP_Status(
    WN_MAP_TAB *maptab
);
...
BE_EXPORTED extern void IPA_WN_MAP_Delete(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map
);
...
BE_EXPORTED extern void IPA_WN_MAP_Set(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    WN          *wn,
    void        *thing
);
BE_EXPORTED extern void IPA_WN_MAP32_Set(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    WN          *wn,
    INT32       thing
);
BE_EXPORTED extern void IPA_WN_MAP64_Set(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    WN          *wn,
    INT64       thing
...
BE_EXPORTED extern void *IPA_WN_MAP_Get(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    const WN    *wn
);
BE_EXPORTED extern INT32 IPA_WN_MAP32_Get(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    const WN    *wn
);
BE_EXPORTED extern INT64 IPA_WN_MAP64_Get(
    WN_MAP_TAB  *maptab,
    WN_MAP      wn_map,
    const WN    *wn
);
...
BE_EXPORTED extern void WN_MAP_Add_Free_List(
    WN_MAP_TAB  *maptab,
    WN          *wn
);

BE_EXPORTED extern void WN_MAP_Set_ID(
    WN_MAP_TAB	*maptab,
    WN		*wn
);
