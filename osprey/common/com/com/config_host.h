...
/* 
 * Arthur: this is defined in Makefile.gsetup now
...
BE_EXPORTED extern void Preconfigure_Host (void);

/* Configuration after flag processing: */
BE_EXPORTED extern void Configure_Host (void);

/* Reconfiguration for each source file: */
BE_EXPORTED extern void Configure_Source_Host ( char *filename );
