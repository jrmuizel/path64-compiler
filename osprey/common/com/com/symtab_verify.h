...
BE_EXPORTED extern void ST_Verify_Class_Sclass (ST_CLASS, ST_SCLASS );

BE_EXPORTED extern void ST_Verify_Sclass_Export (ST_SCLASS, ST_EXPORT, const ST* st = NULL);

BE_EXPORTED extern void TY_Verify_Kind_Mtype (TY_KIND , mTYPE_ID );
...
BE_EXPORTED extern void  Verify_LOCAL_SYMTAB (const SCOPE& , SYMTAB_IDX );

BE_EXPORTED extern void  Verify_GLOBAL_SYMTAB ();
