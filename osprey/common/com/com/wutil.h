...
BE_EXPORTED char *get_intrinsic_name(INTRINSIC opcode);
BE_EXPORTED char *get_iostatement_name(IOSTATEMENT opcode);
BE_EXPORTED char *get_ioitem_name(IOITEM opcode);
BE_EXPORTED char *get_iolibrary_name(IOLIB opcode);

#ifdef TARG_ST
BE_EXPORTED extern TY_IDX WN_intrinsic_return_ty (INTRINSIC intr_opc);
#endif
