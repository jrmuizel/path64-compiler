...
*/
BE_EXPORTED extern const DST_IDX DST_INVALID_IDX;
...
*/
BE_EXPORTED extern char * DST_idx_to_string(DST_IDX);
...
BE_EXPORTED extern DST_TYPE Current_DST;
