...
/* The previous Roundup macro was unsafe in case _value was not of the same type as _align */
#define Roundup(_value,_align) \
  ({ \
    __typeof__(_value) __align = (_align) ; (((_value)+(__align-1)) & (~(__align-1))) ; \
  })
