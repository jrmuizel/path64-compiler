...
#define PU_IS_PROFILER     0x20 // PU is a gcov thunk init function 
...
BE_EXPORTED extern void PU_Info_init (PU_Info *pu);
BE_EXPORTED extern INT Sizeof_PU_Infos (PU_Info *pu_tree);
BE_EXPORTED extern INT Write_PU_Infos (PU_Info *pu_tree, char *base);
BE_EXPORTED extern PU_Info *Read_PU_Infos (char *base, INT32 size, INT32 *p_num_PUs);

BE_EXPORTED extern PU_Info *Current_PU_Info;

BE_EXPORTED extern void Save_Local_Symtab (SYMTAB_IDX level, PU_Info *pu);
BE_EXPORTED extern void Restore_Local_Symtab (PU_Info *pu);
