...
UINT Int_Preg_Max_Offset           =  127;
UINT Ptr_Preg_Min_Offset              =  1;
UINT Ptr_Preg_Max_Offset           =  0;
UINT Float_Preg_Min_Offset         =  128;
UINT Float_Preg_Max_Offset         =  255;
UINT Branch_Preg_Min_Offset        =  256;
UINT Branch_Preg_Max_Offset        =  263;
...
UINT First_Int_Preg_Return_Offset	= 8;	/* register v0 */
UINT Last_Int_Preg_Return_Offset	= 11;	/* register v1 */
UINT First_Ptr_Preg_Return_Offset       = 0;
UINT Last_Ptr_Preg_Return_Offset        = 0;
UINT First_Float_Preg_Return_Offset	= 136;	/* register f0 */
UINT Last_Float_Preg_Return_Offset	= 143;	/* register f2 */

/* Parameter placement */
UINT First_Int_Preg_Param_Offset	= 32;	/* register a0 */
UINT First_Ptr_Preg_Param_Offset        = 0;
UINT First_Float_Preg_Param_Offset	= 136;	/* register fa0 */

UINT Stack_Pointer_Preg_Offset	= 12;	/* register sp */
UINT Frame_Pointer_Preg_Offset	= 7;	/* register fp */
UINT Static_Link_Preg_Offset		= 14;
...
SIM SIM_Info[] = {
  ...
  { /* ABI_I32 */
	...
	{I0+32,I0+39,1}, {I0+32,I0+39,1}, {F0+8,F0+15,1}, {F0+8,F0+15,1},
	{I0+8,I0+11,1}, {I0+8,I0+11,1}, {F0+8,F0+15,1}, {F0+8,F0+15,1},
	MTYPE_I8, MTYPE_I8, MTYPE_F8, MTYPE_F8,
	0, 64, -64, 
	-1, 256, I0+2, I0+25
  },
  { /* ABI_I64 */
