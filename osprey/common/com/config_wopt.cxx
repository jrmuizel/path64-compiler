...
#ifdef TARG_ST
// [CG]: Set to false. Bug id 1-0-7-A/20. 
// Problem in BB_LOOP::Invariant_cr called from different loops
BOOL  WOPT_Enable_Prune = FALSE;
#else
...
//     0, 0, 0,    &WOPT_Enable_Feedback_EPRE, NULL },
  ...
  { OVK_BOOL,	OV_INTERNAL,	TRUE, "fpfsa", "fpfsa",
    TRUE, 0, 0,	&WOPT_Enable_FPFSA, NULL },
#ifdef TARG_ST
