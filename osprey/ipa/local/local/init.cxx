...
// from ipa/local/loop_info.cxx
#include "loop_info.h"
BE_EXPORTED extern void (DO_LOOP_INFO_BASE::*DLIB_Print_p) (FILE *, INT);

// fromm be/com/wb_ipl_summary.cxx 
#include "dep_graph.h"
#include "prompf.h"
#include "wb_browser.h"
BE_EXPORTED extern void (WB_BROWSER::*Summary_p) (FILE *);
#endif
...
#ifdef _NO_WEAK_SUPPORT_
        DLIB_Print_p = &DO_LOOP_INFO_BASE::Print;
        Summary_p = &WB_BROWSER::Summary;
#endif
    }
} Ipl_Initializer;
