...
typedef  __GNUEXT::hash_map<const char*, UINT, __GNUEXT::hash<const char*>, eqstr > INLINE_PU_MAP;
typedef  __GNUEXT::hash_map<const INT, UINT, __GNUEXT::hash<INT> > INLINE_EDGE_MAP;
