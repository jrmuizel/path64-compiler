...
typedef __GNUEXT::hashtable<TY_IDX, TY, TY_HASH, TY_EXTRACT_KEY, __GNUEXT::equal_to<TY>,
...
typedef __GNUEXT::hashtable<FLD_IDX, FLD_IDX, FLD_HASH, __GNUEXT::identity<FLD_IDX>,
...
typedef __GNUEXT::hashtable<ARB_IDX, ARB_IDX, ARB_HASH, __GNUEXT::identity<ARB_IDX>,
...
typedef __GNUEXT::hashtable<TYLIST_IDX, TYLIST_IDX, TYLIST_HASH, __GNUEXT::identity<TYLIST_IDX>,
...
typedef __GNUEXT::hash_multiset<TY_INDEX, partial_ty_hash, ty_index_compare,
...
#ifdef TARG_ST
    // [CL] alignment needs to be *at least* 4,
    // not exactly 4. Used to fail under Sparc/Solaris
