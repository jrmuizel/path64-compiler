...
{ 
  ...
  Transitions(alu, 
	   ...
	   236,	 Final(TOP_pswset_i),
	   237,	 Final(TOP_pswset_ii),
	   238,	 Final(TOP_pswclr_i),
	   239,	 Final(TOP_pswclr_ii),
	   240,	 Final(TOP_rfi),
	   241,	 Final(TOP_sbrk),
	   242,	 Final(TOP_sh1add_r),
	   243,	 Final(TOP_sh1add_i),
	   244,	 Final(TOP_sh1add_ii),
	   245,	 Final(TOP_sh2add_r),
	   246,	 Final(TOP_sh2add_i),
	   247,	 Final(TOP_sh2add_ii),
	   248,	 Final(TOP_sh3add_r),
	   249,	 Final(TOP_sh3add_i),
	   250,	 Final(TOP_sh3add_ii),
	   251,	 Final(TOP_sh4add_r),
	   252,	 Final(TOP_sh4add_i),
	   253,	 Final(TOP_sh4add_ii),
	   254,	 Final(TOP_shl_r),
	   255,	 Final(TOP_shl_i),
	   256,	 Final(TOP_shl_ii),
	   257,	 Final(TOP_shr_r),
	   258,	 Final(TOP_shr_i),
	   259,	 Final(TOP_shr_ii),
	   260,	 Final(TOP_shru_r),
	   261,	 Final(TOP_shru_i),
	   262,	 Final(TOP_shru_ii),
	   263,	 Final(TOP_slct_r),
	   264,	 Final(TOP_slct_i),
	   265,	 Final(TOP_slct_ii),
	   266,	 Final(TOP_slctf_r),
	   267,	 Final(TOP_slctf_i),
	   268,	 Final(TOP_slctf_ii),
	   269,	 Final(TOP_stb_i),
	   270,	 Final(TOP_stb_ii),
	   271,	 Final(TOP_sth_i),
	   272,	 Final(TOP_sth_ii),
	   273,	 Final(TOP_stw_i),
	   274,	 Final(TOP_stw_ii),
	   275,	 Final(TOP_sub_r),
	   276,	 Final(TOP_sub_i),
	   277,	 Final(TOP_sub_ii),
	   278,	 Final(TOP_sxtb_r),
	   279,	 Final(TOP_sxth_r),
	   280,	 Final(TOP_sync),
	   281,	 Final(TOP_syscall),
	   282,	 Final(TOP_xor_r),
	   283,	 Final(TOP_xor_i),
	   284,	 Final(TOP_xor_ii),
	   285,	 Final(TOP_zxth_r),
	   286,	 Final(TOP_nop),
	   287,	 Final(TOP_mov_r),
	   288,	 Final(TOP_mov_i),
	   289,	 Final(TOP_mov_ii),
	   290,	 Final(TOP_mtb),
	   291,	 Final(TOP_mfb),
	   292,	 Final(TOP_return),
	      END_TRANSITIONS); 
