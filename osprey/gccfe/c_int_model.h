...
extern TYPE_ID FE_char_To_Mtype(void);
extern TYPE_ID FE_signed_char_To_Mtype(void);
extern TYPE_ID FE_unsigned_char_To_Mtype(void);
extern TYPE_ID FE_short_integer_To_Mtype(void);
extern TYPE_ID FE_short_unsigned_To_Mtype(void);
extern TYPE_ID FE_integer_To_Mtype(void);
extern TYPE_ID FE_unsigned_To_Mtype(void);
extern TYPE_ID FE_long_integer_To_Mtype(void);
extern TYPE_ID FE_long_unsigned_To_Mtype(void);
#ifdef longlong
extern TYPE_ID FE_long_long_integer_To_Mtype(void);
extern TYPE_ID FE_long_long_unsigned_To_Mtype(void);
#endif
