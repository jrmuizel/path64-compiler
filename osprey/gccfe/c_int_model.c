...
#include "config.h"  /* includes config_targ.h for target specific parms */

/* One must be defined */
#ifdef TARG_MIPS
TARGET_INT_MODEL Target_Int_Model = TARGET_INT_LP64;
#endif
#ifdef TARG_IA64
...
TYPE_ID FE_char_To_Mtype () {
  return MTYPE_I1;
}

TYPE_ID FE_signed_char_To_Mtype () {
  return MTYPE_I1;
}

TYPE_ID FE_unsigned_char_To_Mtype () {
  return MTYPE_U1;
}

TYPE_ID FE_short_integer_To_Mtype () {
  return CIM_short(Target_Int_Model);
}

TYPE_ID FE_short_unsigned_To_Mtype () {
  return CIM_ushort(Target_Int_Model);
}

TYPE_ID FE_integer_To_Mtype () {
  return CIM_int(Target_Int_Model);
}

TYPE_ID FE_unsigned_To_Mtype () {
  return CIM_uint(Target_Int_Model);
}

TYPE_ID FE_long_integer_To_Mtype () {
  return CIM_long(Target_Int_Model);
}

TYPE_ID FE_long_unsigned_To_Mtype () {
  return CIM_ulong(Target_Int_Model);
}

#ifdef longlong
TYPE_ID FE_long_long_integer_To_Mtype () {
  return CIM_long_long(Target_Int_Model);
}

TYPE_ID FE_long_long_unsigned_To_Mtype () {
  return CIM_ulong_long(Target_Int_Model);
}
#endif
