...
*/
typedef enum MType {
#define MType(MType,BitWidth,Signed,MemBytes,Comment) MType_ ##MType,
...
#define RegKind(RegKind,Registers,Comment) RegKind_ ##RegKind,
...
#define RegClass(RegClass,BitWidth,MType,LowReg,HighReg,Registers,Comment) RegClass_ ##RegClass,
...
#define Register(Register,Names,RegClass,RegFile,Number,RegKinds,Comment) Register_ ##Register,
...
#define Modifier(Modifier,Parsing) Modifier_ ##Modifier,
...
#define Immediate(Immediate,Parsing) Immediate_ ##Immediate,
...
#define InstrMode(InstrMode,Attributes,IssueLimits,InstrSize) InstrMode_ ##InstrMode,
...
#define Operator(Operator,Parsing,InstrModes,Attributes,IssueClass,Mnemonic,Format,Syntax) Operator_ ##Operator,
...
Operator_CODE_ASM_0_DEST_SRC1_SRC2,
Operator_CODE_ASM_1_DEST_SRC1_SRC2,
Operator_CODE_ASM_2_DEST_SRC1_SRC2,
Operator_CODE_ASM_3_DEST_SRC1_SRC2,
Operator_CODE_ASM_4_DEST_SRC1_SRC2,
Operator_CODE_ASM_5_DEST_SRC1_SRC2,
Operator_CODE_ASM_6_DEST_SRC1_SRC2,
Operator_CODE_ASM_7_DEST_SRC1_SRC2,
Operator_CODE_ASM_8_DEST_SRC1_SRC2,
Operator_CODE_ASM_9_DEST_SRC1_SRC2,
Operator_CODE_ASM_10_DEST_SRC1_SRC2,
Operator_CODE_ASM_11_DEST_SRC1_SRC2,
Operator_CODE_ASM_12_DEST_SRC1_SRC2,
Operator_CODE_ASM_13_DEST_SRC1_SRC2,
Operator_CODE_ASM_14_DEST_SRC1_SRC2,
Operator_CODE_ASM_15_DEST_SRC1_SRC2,
Operator_CODE_ASM_0_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_0_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_1_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_1_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_2_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_2_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_3_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_3_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_4_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_4_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_5_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_5_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_6_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_6_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_7_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_7_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_8_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_8_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_9_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_9_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_10_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_10_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_11_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_11_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_12_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_12_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_13_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_13_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_14_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_14_IDEST_SRC1_ISRCX,
Operator_CODE_ASM_15_IDEST_SRC1_ISRC2,
Operator_CODE_ASM_15_IDEST_SRC1_ISRCX,
...
#define IssueUnit(IssueUnit) IssueUnit_ ##IssueUnit,
...
#define IssueClass(IssueClass,Reservations,Counters,Comment) IssueClass_ ##IssueClass,
