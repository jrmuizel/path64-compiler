...
extern bool SYS_isDirSeparator(char c);
extern bool SYS_isAbsolute(const char *filename);
...
extern bool SYS_matchsuffix(const char *path, const char *suffix);
...
extern char *SYS_getpdir(const char *program);
