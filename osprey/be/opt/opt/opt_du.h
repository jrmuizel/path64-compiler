...
public:
  ...
  OPT_EXPORTED void      Add_Def_Use( WN *def, WN *use );
  OPT_EXPORTED void      Delete_Def_Use( WN *def, WN *use );

  // note: these four should become private (or obsolete), so please
  //       try to use Add_Def_Use()/Delete_Def_Use() instead
  OPT_EXPORTED void      Ud_Add_Def(WN *use, WN *def);
  OPT_EXPORTED void      Du_Add_Use(WN *def, WN *use);
  ...
  OPT_EXPORTED void Remove_Use_From_System(WN *use);
  OPT_EXPORTED void Remove_Def_From_System(WN *def);

  OPT_EXPORTED void Create_Def_List(WN *use);
  OPT_EXPORTED void Create_Use_List(WN *def);

  OPT_EXPORTED void Du_Set_Incomplete( WN *def );
...
extern "C" OPT_EXPORTED DU_MANAGER* Create_Du_Manager(MEM_POOL *);
extern "C" OPT_EXPORTED void        Delete_Du_Manager(DU_MANAGER *, MEM_POOL *);
extern "C" OPT_EXPORTED BOOL        Du_Built(DU_MANAGER *);
