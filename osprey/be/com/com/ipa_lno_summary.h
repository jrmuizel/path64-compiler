...
public: 
  ...
  BE_EXPORTED void Print(FILE* fp, INT procedure_index = -1); 
}; 
...
public: 
  ...
  BE_EXPORTED void Print(FILE* fp, INT formal_index = -1); 
};
...
public: 
  ...
  BE_EXPORTED void Print(FILE* fp, INT common_index = -1); 
};
