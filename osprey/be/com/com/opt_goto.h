...
class BE_EXPORTED_CLASS GOTO_TABLE {
...
public:
  BE_EXPORTED_METHOD GOTO_TABLE(WN *func_nd, MEM_POOL *pool) : _gd(pool), _bad_label(pool),
  ...
  BE_EXPORTED_METHOD void Remove_Gotos();
  BE_EXPORTED_METHOD void Print(FILE *fp);
  ~GOTO_TABLE()  {  
