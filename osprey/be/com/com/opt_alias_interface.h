...
BE_EXPORTED struct ALIAS_MANAGER *Create_Alias_Manager(MEM_POOL *);

BE_EXPORTED void Delete_Alias_Manager(struct ALIAS_MANAGER *, MEM_POOL *);

BE_EXPORTED void Create_Restricted_Map(MEM_POOL *);

BE_EXPORTED void Copy_Restricted_Map(WN *, struct ALIAS_MANAGER *);

BE_EXPORTED void Delete_Restricted_Map(void);

BE_EXPORTED void Erase_Restricted_Mapping(WN *);

BE_EXPORTED void Verify_Restricted_Map(const WN *, const POINTS_TO *);

BE_EXPORTED BOOL Update_From_Restricted_Map(WN *, POINTS_TO *);

BE_EXPORTED void Note_Invalid_Based_Symbol(const ST *);

BE_EXPORTED struct ALIAS_RULE *Alias_Rule(struct ALIAS_MANAGER *);

BE_EXPORTED ALIAS_CONTEXT Get_Default_Alias_Context(struct ALIAS_MANAGER *);

BE_EXPORTED void Set_Alias_Context(struct ALIAS_MANAGER *, ALIAS_CONTEXT);

BE_EXPORTED void Reset_Alias_Context(struct ALIAS_MANAGER *);

/* to be deleted */ void Assign_preg_alias_id(struct ALIAS_MANAGER *, WN *);

BE_EXPORTED BOOL No_alias(const struct ALIAS_MANAGER *am, WN *wn);

BE_EXPORTED BOOL Valid_alias(const struct ALIAS_MANAGER *am, WN *wn);

BE_EXPORTED ALIAS_RESULT Aliased(const struct ALIAS_MANAGER *, WN *, WN *);

BE_EXPORTED ALIAS_RESULT Overlapped_base(const struct ALIAS_MANAGER *, const WN *, const WN *);

BE_EXPORTED ALIAS_RESULT Aliased_with_region(const struct ALIAS_MANAGER *, const WN *, const WN *, READ_WRITE);

BE_EXPORTED ALIAS_RESULT Aliased_with_intr_op(const struct ALIAS_MANAGER *, const WN *, const WN *);

BE_EXPORTED void Note_Invalid_IP_Alias_Class(ALIAS_MANAGER *, const WN *);

BE_EXPORTED void Invalidate_Persistent_Alias_Info(ALIAS_MANAGER *, WN *);

BE_EXPORTED BOOL Homing_Load( const struct ALIAS_MANAGER *, const WN *load_wn );
BE_EXPORTED void Set_Homing_Load( struct ALIAS_MANAGER *, WN *load_wn );
BE_EXPORTED void Reset_Homing_Load( struct ALIAS_MANAGER *, WN *load_wn );

BE_EXPORTED BOOL Homing_Store( const struct ALIAS_MANAGER *, const WN *store_wn );
BE_EXPORTED void Set_Homing_Store( struct ALIAS_MANAGER *, WN *store_wn );
BE_EXPORTED void Reset_Homing_Store( struct ALIAS_MANAGER *, WN *store_wn );

BE_EXPORTED void Copy_alias_info(const struct ALIAS_MANAGER *, WN *, WN *);

BE_EXPORTED void Duplicate_alias_info(struct ALIAS_MANAGER *, WN *, WN *);

OPT_EXPORTED BOOL Verify_alias(struct ALIAS_MANAGER *, WN *); /* opt_verify.cxx */

BE_EXPORTED void Assign_alias_id(struct ALIAS_MANAGER *, WN *);

BE_EXPORTED void Create_alias(struct ALIAS_MANAGER *, WN *);

BE_EXPORTED void Create_local_alias(struct ALIAS_MANAGER *, WN *);

BE_EXPORTED void Create_global_alias(struct ALIAS_MANAGER *, ST *, WN *, WN *);

BE_EXPORTED void Create_formal_alias(struct ALIAS_MANAGER *, ST *, WN *, WN *);

BE_EXPORTED void Create_vector_alias(struct ALIAS_MANAGER *, WN *, WN *);

BE_EXPORTED void Create_unique_pointer_alias(struct ALIAS_MANAGER *, ST *, WN *, WN *);

BE_EXPORTED void Create_lda_array_alias(struct ALIAS_MANAGER *, WN *, WN *);

BE_EXPORTED void Print_alias_info(char *, const struct ALIAS_MANAGER *, const WN *);

BE_EXPORTED BOOL May_refer_to_alloca_mem(const struct ALIAS_MANAGER *, const WN *);

BE_EXPORTED BOOL Safe_to_speculate(const struct ALIAS_MANAGER *, const WN *);

BE_EXPORTED void Dump_alias_mgr(const struct ALIAS_MANAGER *, const  WN *, FILE *fp);

#ifdef __cplusplus
}  /* end extern "C" */
#endif

BE_EXPORTED extern void PU_adjust_addr_flags(ST*, WN*);
