...
public: 
  ...
  BE_EXPORTED void Load_Buffer(); 
  BE_EXPORTED void Load_Buffer(char s[]); 
  BE_EXPORTED void Scan_Blanks_And_Tabs(); 
  ...
  BE_EXPORTED void Skip_Chars(INT int_value); 
  BE_EXPORTED char Scan_Character(); 
  BE_EXPORTED void Pushback_Character(); 
  BE_EXPORTED void Scan_Integer(INT* int_value); 
  BE_EXPORTED void Scan_Unsigned(UINT32* int_value); 
  BE_EXPORTED void Scan_HexInteger(INT* int_value); 
  BE_EXPORTED void Scan_Alphanumeric(char s[]); 
  BOOL Is(char ch) {return _buffer[_buffer_start] == ch;};
  BE_EXPORTED BOOL Is_Integer();  
  BE_EXPORTED char Get_Command(); 
}; 
