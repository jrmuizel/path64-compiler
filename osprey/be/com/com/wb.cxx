...
// [HK]
#if __GNUC__ >=3
extern void s_lno_debug(char init_buffer[]) __attribute__((weak));
extern void cg_sdebug(char init_buffer[]) __attribute__((weak));
#else
extern void s_lno_debug(char*);
extern void cg_sdebug(char*);
#pragma weak s_lno_debug__FPc
#pragma weak cg_sdebug__FPc
#endif // __GNUC__ >=3
#else
extern void (*s_lno_debug_p)(char*);
#define s_lno_debug (*s_lno_debug_p)
extern void (*cg_sdebug_p)(char*);
#define cg_sdebug (*cg_sdebug_p)
#endif
#else
