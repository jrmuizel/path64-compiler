...
public:
  ...
  IPL_EXPORTED void Fill_Out(); 

  IPL_EXPORTED void Simplify();
  void LNO_Simplify(IPA_LNO_READ_FILE* IPA_LNO_File, WN* wn_call);
...
// [HK]
#ifndef _SUPPORT_IPA
class IPL_EXPORTED_CLASS PROJECTED_REGION
#else
class PROJECTED_REGION
#endif // _SUPPORT_IPA
{
...
public:
  ...
  IPL_EXPORTED_METHOD PROJECTED_REGION(mINT16 type,
                   mUINT8 depth, 
                   mUINT8 num_dim, 
                   MEM_POOL* mem_pool);
  ...
  IPL_EXPORTED void IPA_LNO_Print(FILE* fp = stderr, IPA_LNO_READ_FILE* 
    IPA_LNO_File = NULL);
// [HK]
#ifndef _SUPPORT_IPA
  IPL_EXPORTED 
