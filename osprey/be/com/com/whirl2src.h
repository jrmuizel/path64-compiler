...
/* Whirl2C functions */
W2C_EXPORTED extern void W2C_Cleanup(void);
W2C_EXPORTED extern void W2C_Init(void);
W2C_EXPORTED extern void W2C_Outfile_Fini(BOOL emit_global_decls);
W2C_EXPORTED extern void W2C_Outfile_Init(BOOL emit_global_decls);
W2C_EXPORTED extern void W2C_Outfile_Translate_Pu(WN *pu, BOOL emit_global_decls);
W2C_EXPORTED extern void W2C_Pop_PU(void);
W2C_EXPORTED extern void W2C_Process_Command_Line(INT phase_argc, 
                                     char * const phase_argv[], 
                                     INT argc, 
                                     char * const argv[]);
W2C_EXPORTED extern void W2C_Push_PU(const WN *pu, WN *body_part_of_interest);
W2C_EXPORTED extern void W2C_Set_Frequency_Map(WN_MAP frequency_map);
W2C_EXPORTED extern void W2C_Set_Prompf_Emission(const WN_MAP *construct_map);
W2C_EXPORTED extern BOOL W2C_Should_Emit_Nested_PUs(void);
W2C_EXPORTED extern void W2C_Translate_Istore_Lhs(char *strbuf,
                                     UINT bufsize, 
                                     const WN* lhs, 
                                     mINT64 istore_ofst, 
                                     TY_IDX istore_addr_ty,
                                     TYPE_ID istore_mtype);
W2C_EXPORTED extern void W2C_Translate_Wn(FILE *outfile, const WN *wn);
W2C_EXPORTED extern void W2C_Translate_Wn_Str(char *strbuf, UINT bufsize, const WN *wn);

/* Whirl2F functions */
W2F_EXPORTED extern void W2F_Cleanup(void);
W2F_EXPORTED extern void W2F_Init(void);
W2F_EXPORTED extern void W2F_Outfile_Fini(void);
W2F_EXPORTED extern void W2F_Outfile_Init(void);
W2F_EXPORTED extern void W2F_Outfile_Translate_Pu(WN *pu);
W2F_EXPORTED extern void W2F_Pop_PU(void);
W2F_EXPORTED extern void W2F_Process_Command_Line(INT phase_argc, 
                                     char *phase_argv[],
                                     INT argc, 
                                     char *argv[]);
W2F_EXPORTED extern void W2F_Push_PU(WN *pu, WN *body_part_of_interest);
W2F_EXPORTED extern void W2F_Set_Frequency_Map(WN_MAP frequency_map);
W2F_EXPORTED extern void W2F_Set_Prompf_Emission(WN_MAP *construct_map);
W2F_EXPORTED extern BOOL W2F_Should_Emit_Nested_PUs(void);
W2F_EXPORTED extern void W2F_Translate_Istore_Lhs(char *strbuf, 
                                     UINT bufsize,
                                     WN* lhs, 
                                     mINT64 istore_ofst, 
                                     TY_IDX istore_addr_ty, 
                                     TYPE_ID istore_mtype);
W2F_EXPORTED extern void W2F_Translate_Wn(FILE *outfile, WN *wn);
W2F_EXPORTED extern void W2F_Translate_Wn_Str(char *strbuf, UINT bufsize, WN *wn);

/* Interface functions for LNO */
BE_EXPORTED extern void Whirl2Src_Init (WN* func_nd);
BE_EXPORTED extern void Whirl2Src_Emit (FILE* fp, WN* wn);

BE_EXPORTED extern void Whirl2C_Init (WN* func_nd);
BE_EXPORTED extern void Whirl2C_Emit (FILE* fp, WN* wn);

BE_EXPORTED extern void Whirl2F_Init (WN* func_nd);
BE_EXPORTED extern void Whirl2F_Emit (FILE* fp, WN* wn);
