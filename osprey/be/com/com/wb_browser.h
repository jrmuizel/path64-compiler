...
// [HK]
#ifndef IPA_SUMMARY
class BE_EXPORTED_CLASS WB_BROWSER {
#else
class  WB_BROWSER {
#endif // IPA_SUMMARY
private: 
...
protected: 
  ...
  BE_EXPORTED_METHOD void Set_Subcommand(char ch);
  BE_EXPORTED_METHOD void Reset_Subcommand();
  ...
  BE_EXPORTED_METHOD void Error_Cleanup(); 
  ...
  // we need to open access for pointer to member function
  // manipulations
 public:
...
__attribute__((weak));
  ...
  BE_EXPORTED_METHOD void Help(); 
  void Invoke_Command(char ch); 
public: 
  BE_EXPORTED_METHOD WB_BROWSER(); 
  ...
  BE_EXPORTED_METHOD void Sdebug(char init_buffer[]);
  void Debug(); 
}; 
