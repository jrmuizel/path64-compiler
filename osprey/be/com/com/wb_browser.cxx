...
extern void (DO_LOOP_INFO_BASE::*DLIB_Print_p) (FILE *, INT);
extern void (IF_INFO::*II_Print_p) (FILE *);
extern void (ACCESS_ARRAY::*AA_Print_p) (FILE *) const;
extern void (WB_BROWSER::*Summary_p) (FILE *);
#define Summary (this->*Summary_p)
#else
// [HK]
#if __GNUC__ <3
#ifdef __linux__
