...
BE_EXPORTED extern INT32 Gcd(mINT32, mINT32);
BE_EXPORTED extern INT64 Gcd(mINT64, mINT64);
BE_EXPORTED extern INT32 Gcd(const mINT32*, INT);
BE_EXPORTED extern INT64 Gcd(const mINT64*, INT);

BE_EXPORTED extern INT32 Lcm(mINT32, mINT32);
BE_EXPORTED extern INT64 Lcm(mINT64, mINT64);
BE_EXPORTED extern INT32 Lcm(const mINT32*, INT);
BE_EXPORTED extern INT64 Lcm(const mINT64*, INT);
