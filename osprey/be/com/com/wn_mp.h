...
BE_EXPORTED extern WN * Gen_OMP_Begin_SPR (MP_process_type mpt);
BE_EXPORTED extern WN * Gen_OMP_End_SPR   (MP_process_type mpt);
...
BE_EXPORTED extern BOOL WN_has_pragma_with_side_effect ( WN *wn );
