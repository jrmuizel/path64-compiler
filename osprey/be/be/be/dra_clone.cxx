...
BE_EXPORTED BOOL Run_Dsm_Cloner = FALSE;

BE_EXPORTED BOOL Run_Dsm_Common_Check = FALSE;

BE_EXPORTED BOOL Run_Dsm_Check = FALSE;

BE_EXPORTED NAME_ST_TABLE *DRA_func_table = NULL;

BE_EXPORTED MEM_POOL DRA_name_pool, *DRA_name_pool_ptr = NULL;

BE_EXPORTED DRA_GLOBAL_HASH_TABLE* dra_global = NULL;
