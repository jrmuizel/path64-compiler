...
BE_EXPORTED BOOL Prompf_anl_loaded = FALSE;
BE_EXPORTED BOOL Purple_loaded = FALSE;
BE_EXPORTED BOOL Whirl2f_loaded = FALSE;
BE_EXPORTED BOOL Whirl2c_loaded = FALSE;
