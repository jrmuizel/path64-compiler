...
#ifndef TARG_ST
// Target_ISA_Has_Prefetch and Target_Proc_Run_Prefetch moved
// to targinfo/lno/targ_prefetch.h.
...
#ifdef TARG_ST
    // FdF 2004-09-10: Manual prefetch ON by default to fix DDTS
    // MBTst17811.
    else LNO_Run_Prefetch_Manual = TRUE;
#else
...
static void Prefetch_Manual (WN* func_nd) {
  ...
  // Cache information is now used in Process_Loop_Manual
  Cache.Initialize ();
