...
W2C_EXPORTED extern void W2C_Process_Command_Line(INT phase_argc, char * const phase_argv[],
				     INT argc, char * const argv[]);
W2C_EXPORTED extern void W2C_Init(void);
W2C_EXPORTED extern void W2C_Fini(void);
W2C_EXPORTED extern void W2C_Push_PU(const WN *pu, WN *body_part_of_interest);
W2C_EXPORTED extern void W2C_Pop_PU(void);

W2C_EXPORTED extern void W2C_Mark_Loads(void);
W2C_EXPORTED extern void W2C_Nomark_Loads(void);
...
W2C_EXPORTED extern const char *W2C_Get_Transformed_Src_Path(void);

W2C_EXPORTED extern void W2C_Set_Purple_Emission(void);
W2C_EXPORTED extern void W2C_Reset_Purple_Emission(void);

W2C_EXPORTED extern void W2C_Translate_Global_Types(FILE *outfile);
W2C_EXPORTED extern void W2C_Translate_Global_Defs(FILE *outfile);

W2C_EXPORTED extern const char *W2C_Object_Name(const ST *func_st);

W2C_EXPORTED extern void W2C_Translate_Stid_Lhs(char       *strbuf,
				   UINT        bufsize,
				   const ST   *stid_st, 
				   mINT64      stid_ofst, 
				   TY_IDX      stid_ty, 
