      ...
      for (force = 0; force < 2; force++)
	{
	  ...
	  if (command_line.rpath_link == NULL
	      && command_line.rpath == NULL)
	    {
	      ...
	      if (gldelf64ltsmip_search_needed (lib_path, &n,
						      force))
		break;
	    }
	  lib_path = (const char *) getenv ("LD_LIBRARY_PATH");
	  if (gldelf64ltsmip_search_needed (lib_path, &n, force))
	    break;
	  found = 0;
...
OUTPUT_ARCH(mips)\n\
ENTRY(__start)\n\
SEARCH_DIR(\"/home/pathscle/pathscale-release/mips-pathscale-linux/lib64\"); SEARCH_DIR(\"/home/pathscle/pathscale-release/lib64\"); SEARCH_DIR(\"/usr/local/lib64\"); SEARCH_DIR(\"/lib64\"); SEARCH_DIR(\"/usr/lib64\"); SEARCH_DIR(\"/home/pathscle/pathscale-release/mips-pathscale-linux/lib\"); SEARCH_DIR(\"/home/pathscle/pathscale-release/lib\"); SEARCH_DIR(\"/usr/local/lib\"); SEARCH_DIR(\"/lib\"); SEARCH_DIR(\"/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
