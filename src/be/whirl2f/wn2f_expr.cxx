...
static const CONV_OP Conv_Op_Map[] = 
{
   ...
   {MTYPE_I1, MTYPE_F16, "QEXT"},
   {MTYPE_I2, MTYPE_F16, "QEXT"},
   {MTYPE_I4, MTYPE_F16, "QEXT"},
   {MTYPE_I8, MTYPE_F16, "QEXT"},
   {MTYPE_U1, MTYPE_F16, "QEXT"},
   {MTYPE_U2, MTYPE_F16, "QEXT"},
   {MTYPE_U4, MTYPE_F16, "QEXT"},
   {MTYPE_U8, MTYPE_F16, "QEXT"},
   {MTYPE_F4, MTYPE_F16, "QEXT"},
   {MTYPE_F8, MTYPE_F16, "QEXT"}
   /*{MTYPE_FQ, MTYPE_F16, ""}*/
   /*{MTYPE_F16, MTYPE_F16, ""}*/
}; /* Conv_Op_Map */
...
WN2F_recip(TOKEN_BUFFER tokens, WN *wn, WN2F_CONTEXT context)
{
   ...
   if (TY_mtype(result_ty) == MTYPE_FQ || TY_mtype(result_ty) == MTYPE_CQ ||
       TY_mtype(result_ty) == MTYPE_F16 || TY_mtype(result_ty) == MTYPE_C16)
