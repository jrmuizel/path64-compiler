...
static const char *rcs_id = "$Source: ../../be/lno/SCCS/s.model.cxx $ $Revision: 1.21 $";
      ...
      if (_is_floating_point && MTYPE_float(type)) {
        if ((type == MTYPE_F4) || (type == MTYPE_F8)) {
          ...
          Enter(&symb, is_store, 1);
                   ...
                   type == MTYPE_FQ || type == MTYPE_F16) {
          SYMBOL symb(wn);
          (*num_scalar_refs)+=2;
          Enter(&symb, is_store, 2);
        } else if (type == MTYPE_CQ || type == MTYPE_C16) {
          SYMBOL symb(wn);
          (*num_scalar_refs)+=4;
...
REGISTER_MODEL::Count_Op(WN* wn)
{
  ...
  if (opcode == OPC_BLOCK) {
    ...
    if ((ti == MTYPE_C4) || (ti == MTYPE_C8) ||
	(ti == MTYPE_CQ) || (ti == MTYPE_C16) ||
        (ti2 == MTYPE_C4) || (ti2 == MTYPE_C8) ||
	(ti2 == MTYPE_CQ) || (ti2 == MTYPE_C16) ||
        (ti == MTYPE_FQ) || (ti2 == MTYPE_FQ) ||
	(ti == MTYPE_F16) || (ti2 == MTYPE_F16)) {
        result = 2.0;
