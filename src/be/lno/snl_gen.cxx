...
static const char *rcs_id =   snl_CXX "$Revision: 1.9 $";
...
static void UT_Generate_Imperfect_If_Code(DOLOOP_STACK*	stack,
					  ...
					  SNL_TRANS_INDEX_DATA* td)
{
  FmtAssert(FALSE, ("TODO: imperfect interchange not implemented. "
		    "(e.g. DU updating.)"));
			      ...
			      SNL_TRANS_INDEX_DATA* td)
{
  ...
  for (WN* wn = WN_first(body); wn; wn = WN_next(wn)) {
	...
	UT_Body_Imperfect(WN_do_body(wn), stack, first_in_stack,
     ...
     case OPC_DO_WHILE:
     case OPC_WHILE_DO:
      FmtAssert(FALSE, ("while loops can't exist within SNL"));
      break;
     default:
      UT_Body_Exp(wn, td);
      break;
