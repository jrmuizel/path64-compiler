                                                         ...
                                                         INT32 ftype, WN * wn ) 
{
  ...
  if (WN_opcode(wn) == OPC_I4INTCONST)
	...
	wnx = WN_CreateStid ( OPC_I4STID, foffset, st, Be_Type_Tbl(MTYPE_I4),
      ...
      else if (vtype == MTYPE_F16)
	wnx = WN_CreateStid ( OPC_I4STID, foffset, st, Be_Type_Tbl(MTYPE_I4),
	      WN_CreateExp1 ( OPC_I4F16CVT,
	      WN_CreateLdid ( OPC_F16F16LDID, WN_offset(wn), WN_st(wn),
			      Be_Type_Tbl(MTYPE_F16) )));
      else
	...
	wnx = WN_CreateStid ( OPC_I4STID, foffset, st, Be_Type_Tbl(MTYPE_I4),
      ...
      else if (etype == MTYPE_F16)
	wnx = WN_CreateStid ( OPC_I4STID, foffset, st, Be_Type_Tbl(MTYPE_I4),
	      WN_CreateExp1 ( OPC_I4F16CVT, wn ));
      else
...
static void Gen_Io_PutFieldST ( WN * block, ST * st, FIOSTRUCT field, ST * var )
{
  ...
  if (ftype == MTYPE_I4)
    ...
    if (vtype == MTYPE_I4)
      ...
      wn = WN_CreateStid ( OPC_I4STID, foffset, st, Be_Type_Tbl(MTYPE_I4),
	   WN_CreateExp1 ( OPC_I4F16CVT,
	   WN_CreateLdid ( OPC_F16F16LDID, 0, var, Be_Type_Tbl(MTYPE_F16) )));
    else
