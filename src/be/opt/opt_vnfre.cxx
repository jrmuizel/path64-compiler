...
#if defined( KEY) // bug 9114 : this code moved from inside _select_and_sort_valnums
...
#if !defined( KEY) // bug 9114 : this code moved to caller
      VALNUM_TO_EXPR_LIST vn_to_exprid(*_vn, _lpool);
#endif
...
VALNUM_FRE::_ivc_classify(BB_NODE *loop_header, VN_IVC &vn_ivc)
{
   ...
   FOR_ALL_ELEM(phi, phi_iter, Init(loop_header->Phi_list()))
   {
	     ...
	     _is_real_var(phi_result))          // Has a memory location
	 {
	    ...
	    {
#if defined( KEY) // bug 9114 : without this, could falsely identify class for the
