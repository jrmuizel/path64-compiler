...
extern BOOL OP_is_like_muld (OP *op);		// mul.d bug 13027
extern BOOL OP_disrupts_muld (OP *op);		// mul.d bug 13027
extern BOOL CGTARG_Is_Delay_Slot_Op (OP *op);	// mul.d bug 13027
#endif
extern void CGTARG_Process_Asm_lh_constraints (TN **tns, OPS *ops);
#endif
