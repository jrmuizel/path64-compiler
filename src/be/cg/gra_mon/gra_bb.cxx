                            ...
                            )
{
  ...
  if (lrange->Contains_Internal_BB(this)) {
    ...
    // It is not an error if the register is unavailable throughout the BB.
    // This can happen for preferenced registers and register reuse under SWP.
    if (this_usage_start_index == 1 &&
	this_usage_end_index == max_OP_index) {
      return;
    }
