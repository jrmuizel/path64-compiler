...
static void Warn_Unused_Pragma(WN* pragma, CLEAR_INLINE_PRAGMA warn, const char* scope)
{
  if (warn == SILENT) {
    return;
  }
...
static void Clear_Pragma_List(WN** list, CLEAR_INLINE_PRAGMA warn, const char* scope)
{
  WN* cur = *list;
  WN* next = NULL;
  while (cur) {
