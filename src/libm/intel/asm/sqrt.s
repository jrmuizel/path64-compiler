...
__sqrt:
 ...
 (p6)	br.cond.dptk		nan	// branch if arg is a NaN
	;;
	frsqrta.s0	f13,p6=farg0	// y2 = ~1/sqrt(x)
	;;

 (p6)	addl    r16=@gprel(half),gp
	;;
 (p6)	ldfd	f11=[r16],8	// f11 = 0.5
	;;
 (p6)	ldfd	f14=[r16]	// f14 = 0x3fe0000000000001
	;;
 ...
 (p6)	fma.s1	f9=f15,f13,f9	// y = y + e*y2
	;;
 (p6)	fma.s1	f10=f9,f12,f10	// g = g + y*d   64 bit approximation before rounding
	;;
 (p6)	fadd.s1	f13=f9,f9     // y2 = y + y
	;;
 (p6)	fnma.s1	f15=f9,f10,f14	// e = ah - y*g
 ...
 (p6)	fma.s1	f9=f15,f13,f9	// y = y + e*y2
	;;
 (p6)	fma.d.s0	f8=f9,f12,f10  // result = g + y*d
