...
#ifdef KEY /* Bug 7969 */
extern  void            gen_runtime_substring(int, boolean);
extern  void            gen_runtime_bounds(int, boolean);
#else /* KEY Bug 7969 */
...
#ifdef KEY /* Bug 14293, 11986, 6845, 12711 */
extern int help_dealloc(int, int, fld_type, int, boolean, boolean, boolean);
extern int allocatable_structure_component(int);
void dealloc_allocatables(int, int, int, fld_type, int, boolean, boolean *);
#endif /* KEY Bug 14293, 11986, 6845, 12711 */
#ifdef KEY /* Bug 14150 */
...
#ifdef KEY /* Bug 5091 */
extern  boolean readonly_protected(int);
#endif /* KEY Bug 5091 */
