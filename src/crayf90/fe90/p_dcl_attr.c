...
#ifdef KEY /* Bug 5091 */
void parse_protected_stmt()
{
   TRACE (Func_Entry, "parse_protected_stmt", NULL);
   ...
   if ((CURR_BLK != Module_Blk ||
	STMT_OUT_OF_ORDER(curr_stmt_category, stmt_type)) &&
      ...
      parse_attrs(merge_protected);
      curr_stmt_category = Declaration_Stmt_Cat;
   }
#endif
   parse_attrs(merge_protected);

   TRACE (Func_Exit, "parse_protected_stmt", NULL);
}  /* parse_protected_stmt */
#endif /* KEY Bug 5091 */
