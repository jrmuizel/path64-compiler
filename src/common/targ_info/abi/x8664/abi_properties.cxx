...
static void x86_64_abi(void)
{
  ...
  enum { YMM0=0, YMM1, YMM2,  YMM3,  YMM4,  YMM5,  YMM6,  YMM7,
  ...
  Reg_Property( func_val, ISA_REGISTER_CLASS_float,
	...
	Reg_Property( allocatable, ISA_REGISTER_CLASS_ymmx,
		YMM0, YMM1, YMM2,  YMM3,  YMM4,  YMM5,  YMM6,  YMM7,
		YMM8, YMM9, YMM10, YMM11, YMM12, YMM13, YMM14, YMM15,
		-1 );
  Reg_Property( callee, ISA_REGISTER_CLASS_ymmx,
		-1 );
  Reg_Property( caller, ISA_REGISTER_CLASS_ymmx,
		YMM0, YMM1, YMM2,  YMM3,  YMM4,  YMM5,  YMM6,  YMM7,
		YMM8, YMM9, YMM10, YMM11, YMM12, YMM13, YMM14, YMM15,
		-1 );
  Reg_Property( func_arg, ISA_REGISTER_CLASS_ymmx,
		YMM0, YMM1, YMM2, YMM3, YMM4, YMM5, YMM6, YMM7,
		-1 );
  Reg_Property( func_val, ISA_REGISTER_CLASS_ymmx,
		YMM0, YMM1,
		-1 );
