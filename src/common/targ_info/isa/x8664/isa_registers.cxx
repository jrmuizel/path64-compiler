...
main (int argc, char** argv)
{
  ...
  ISA_REGISTER_CLASS rc_ymmx    = ISA_Register_Class_Create( "ymmx",   256,  true,  false );
  ...
  ISA_Register_Set( rc_ymmx,    0, 15, "%u", ymm_reg_names,  All_ISA_Mask() );
  ...
  ISA_Register_Subclass_Create("ymm0", rc_ymmx,   1, ymm0_reg, NULL);
