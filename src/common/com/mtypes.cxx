...
TYPE_DESC Machine_Types[MTYPE_MAX_LIMIT+1] = { 
  ...
  { MTYPE_F32, 256,256,256,32, 32,32,	1, 1, 0, "F32",MTYPE_CLASS_FLOAT,32, MTYPE_F32 },
#endif // TARG_X8664
};
 ...
 *
 * Return the vector version of scalar mtype y taking on the number of
 * vector elements in vector mtype  x.
 *
 * ====================================================================
 */
TYPE_ID Mtype_TransferVector(TYPE_ID x, TYPE_ID y)
{
  switch (x) {
#ifdef TARG_X8664
  case MTYPE_V16C4:
  case MTYPE_V16F8:
  case MTYPE_V16I8:
    if (MTYPE_is_complex(y))
      return MTYPE_V16C4;
    else if (MTYPE_is_float(y))
      return MTYPE_V16F8;
    else return MTYPE_V16I8;
  case MTYPE_V32C4:
  case MTYPE_V32I8:
  case MTYPE_V32F8:
  	if (MTYPE_is_complex(y))
	  ...
	  return MTYPE_V32F8;
	else return MTYPE_V32F8;
  case MTYPE_V16I4:
  case MTYPE_V16F4:
    if (MTYPE_is_float(y))
      return MTYPE_V16F4;
    else return MTYPE_V16I4;
  case MTYPE_V32I4:
  case MTYPE_V32F4:
  	if (MTYPE_is_float(y))
	  return MTYPE_V32F4;
	else return MTYPE_V32I4;
