 ...
 * Module: targ_const.c
 * $Revision: 1.6 $
 * $Date: 05/03/04 17:59:14-08:00 $
 * $Author: gautam@jacinth.keyresearch $
 * $Source: common/com/mips/SCCS/s.targ_const.cxx $
 *
 * Revision history:
...
static QUAD_TYPE F8_To_R16(double d) { return RLD_To_R16((long double) d); }
static QUAD_TYPE F4_To_R16(float s) { return RLD_To_R16((long double) s); }
static double R16_To_F8(QUAD_TYPE q) { return (double) R16_To_RLD(q); }
static float R16_To_F4(QUAD_TYPE q) { return (float) R16_To_RLD(q); }
static QUAD_TYPE I8_To_R16(INT64 x)  { return RLD_To_R16((long double) x); }
static QUAD_TYPE U8_To_R16(UINT64 x) { return RLD_To_R16((long double) x); }
static INT64 R16_To_I8(QUAD_TYPE q)  { return (INT64) R16_To_RLD(q); }
static UINT64 R16_To_U8(QUAD_TYPE q) { return (UINT64) R16_To_RLD(q); }
...
I8_To_R16(INT64 sx)
{
  ...
  // printf("I8_To_R16 %" SCNd64 "\n", sx);
  QUAD_TYPE q;
  if (sx == 0) return F4_To_R16(0.0);
  INT32 sign = (sx < 0);
  if (sign) sx = -sx;
  INT32 expon = 63 + 0x00003fff;
  while (sx > 0) {
...
static INT64
R16_To_I8(QUAD_TYPE q)
{
  return (INT64) R16_To_U8(q);
}
...
#ifdef HOST_SUPPORTS_F16_LONG_DOUBLE
  ...
  switch (TCON_ty(*tc)) {
    ...
    case MTYPE_FQ:
    {
     ...
     /*
       ...
       a warning.
     */
     /* MIPS uses 128-bit IEEE float, so this check doesn't apply. */
#if 0
...
static TCON complex_sqrt(TCON c0)
{
   ...
   switch (TCON_ty(c0)) {
	...
	qr = R16_To_RLD(TCON_R16(c0));
	qi = R16_To_RLD(TCON_IR16(c0));
	q0 = 0.0;
	q05 = 0.5;
	...
	TCON_R16(r) = RLD_To_R16(rqr);
	TCON_IR16(r) = RLD_To_R16(rqi);
      }
      break;
#else
#if 0
...
static TCON complex_divide(TCON c0, TCON c1)
{
   ...
   switch (TCON_ty(c0)) {
	...
	INT err;
	q0 = 0.0;
	c0r = R16_To_RLD(TCON_R16(c0));
	c0i = R16_To_RLD(TCON_IR16(c0));
	c1r = R16_To_RLD(TCON_R16(c1));
	c1i = R16_To_RLD(TCON_IR16(c1));
	ar = c1r;
	ai = c1i;
	if (ar < q0) ar = -ar;
	if (ai < q0) ai = -ai;
	...
	TCON_R16(r) = RLD_To_R16(t3);
	TCON_IR16(r) = RLD_To_R16(t1);
      }
      break;
#else
#if 0
...
#undef DEBUG_FOLD
   ...
   *folded = TRUE;
   ...
   if (OPERATOR_is_compare(opr)) {
      ...
      *folded = FALSE;
#else
       q0 = R16_To_RLD(TCON_R16(c0));
       q1 = R16_To_RLD(TCON_R16(c1));
       switch (opr) {
       case OPR_EQ: TCON_v0(c0) = (q0 == q1); break;
       case OPR_NE: TCON_v0(c0) = (q0 != q1); break;
       case OPR_LT: TCON_v0(c0) = (q0 <  q1); break;
       case OPR_LE: TCON_v0(c0) = (q0 <= q1); break;
       case OPR_GT: TCON_v0(c0) = (q0 >  q1); break;
       case OPR_GE: TCON_v0(c0) = (q0 >= q1); break;
       }
       TCON_v1(c0) = 0;
       TCON_v2(c0) = 0;
       TCON_v3(c0) = 0;
     ...
     case MTYPE_F16:
#ifdef HOST_SUPPORTS_F16_LONG_DOUBLE
       q0 = F16_To_RLD(TCON_F16(c0));
       q1 = F16_To_RLD(TCON_F16(c1));
       switch (opr) {
       case OPR_EQ: TCON_v0(c0) = (q0 == q1); break;
       case OPR_NE: TCON_v0(c0) = (q0 != q1); break;
       case OPR_LT: TCON_v0(c0) = (q0 <  q1); break;
      ...
      *folded = FALSE;
       ...
       q0 = R16_To_RLD(TCON_IR16(c0));
       q1 = R16_To_RLD(TCON_IR16(c1));
       switch (opr) {
       case OPR_EQ: TCON_v0(c0) &= (q0 == q1); break;
       case OPR_NE: TCON_v0(c0) |= (q0 != q1); break;
       }
     ...
     case MTYPE_C16:
       ...
       q0 = F16_To_RLD(TCON_IF16(c0));
       q1 = F16_To_RLD(TCON_IF16(c1));
       switch (opr) {
       case OPR_EQ: TCON_v0(c0) &= (q0 == q1); break;
       case OPR_NE: TCON_v0(c0) |= (q0 != q1); break;
       }
    ...
    */
    ...
    case OPC_I4FQRND:
      ...
      *folded = FALSE;
#else
      if (R16_To_RLD(TCON_R16(c0)) >= 0.0) {
	TCON_R16(c0) = RLD_To_R16(R16_To_RLD(TCON_R16(c0)) + 0.5);
      } else {
	TCON_R16(c0) = RLD_To_R16(R16_To_RLD(TCON_R16(c0)) - 0.5);     
      }
      c0 = Targ_Conv(MTYPE_I4,c0);
    ...
    case OPC_I4FQFLOOR:
      ...
      *folded = FALSE;
      ...
      if (R16_To_RLD(TCON_R16(t2)) > R16_To_RLD(TCON_R16(c0))) {
	 TCON_I4(t1) -= 1;
      }
      c0 = t1;
#endif
	...
	TCON_R16(c0) = RLD_To_R16(- R16_To_RLD(TCON_R16(c0)));
      }
#endif
      break;
#endif
...
#else
      TCON_R16(c0) = RLD_To_R16(- R16_To_RLD(TCON_R16(c0)));
      TCON_IR16(c0) = RLD_To_R16(- R16_To_RLD(TCON_IR16(c0)));
#endif
      break;
#endif
    case OPC_C16NEG:
...
#else
      if (R16_To_RLD(TCON_R16(c0)) >= 0.0) {
	TCON_R16(c0) = RLD_To_R16(sqrtl(R16_To_RLD(TCON_R16(c0))));
      } else {
	*folded = FALSE;
      }
#endif
	...
	*folded = FALSE;
    ...
    case OPC_C4SQRT:
    case OPC_C8SQRT:
#if defined(TARG_NEEDS_QUAD_OPS) && !defined(EMULATE_QUAD)
    case OPC_CQSQRT:
#endif
#ifdef HOST_SUPPORTS_F16_LONG_DOUBLE
    case OPC_C16SQRT:
    ...
    case OPC_CQSQRT:
#endif
#ifndef HOST_SUPPORTS_F16_LONG_DOUBLE
    case OPC_C16SQRT:
#endif
      *folded = FALSE;
      break;
	...
	long double a, b, c, d, r1, r2, r3;
	 a = R16_To_RLD(TCON_R16(c0));
	 b = R16_To_RLD(TCON_IR16(c0));
	 c = R16_To_RLD(TCON_R16(c1));
	 d = R16_To_RLD(TCON_IR16(c1));
	 r1 = a * c;
	 r2 = b * d;
	 r3 = r1 - r2;
	 r1 = a * d;
	 r2 = b * c;
	 r1 = r1 + r2;
	 TCON_R16(c0) = RLD_To_R16(r3);
	 TCON_IR16(c0) = RLD_To_R16(r1);
      }
#endif
      break;
#endif
...
/*	 ErrMsg( EC_Ill_UModulus );*/
	*folded = FALSE;
    ...
    case OPC_FQMIN:
      ...
      *folded = FALSE;
#else
      TCON_R16(c0) = (R16_To_RLD(TCON_R16(c0)) < R16_To_RLD(TCON_R16(c1)) ?
  ...
  */
  switch ( FROM_TO(ty_from, ty_to) ) {
    ...
    case FROM_TO(MTYPE_C8, MTYPE_CQ):
      TCON_R16(r) = F8_To_R16(TCON_R8(c));
      TCON_IR16(r) = F8_To_R16(TCON_IR8(c));
      break;
    case FROM_TO(MTYPE_C4, MTYPE_CQ):
      TCON_R16(r) = F4_To_R16(TCON_R4(c));
      TCON_IR16(r) = F4_To_R16(TCON_IR4(c));
      break;
    case FROM_TO(MTYPE_FQ, MTYPE_CQ):
      TCON_R16(r) = TCON_R16(c);
      TCON_IR16(r) = F4_To_R16(0.0);
      break;
    ...
    case FROM_TO(MTYPE_CQ, MTYPE_C8):
      TCON_R8(r) = R16_To_F8(TCON_R16(c));
      TCON_IR8(r) = R16_To_F8(TCON_IR16(c));
      break;
#endif /* TARG_NEEDS_QUAD_OPS */
    ...
    case FROM_TO(MTYPE_CQ, MTYPE_C4):
      TCON_R4(r) = R16_To_F4(TCON_R16(c));
      TCON_IR4(r) = R16_To_F4(TCON_IR16(c));
      break;
#endif /* TARG_NEEDS_QUAD_OPS */
    ...
    case FROM_TO(MTYPE_I1, MTYPE_FQ): 
      TCON_R16(r) = F8_To_R16((double) TCON_v0(c));
      break;
    ...
    case FROM_TO(MTYPE_FQ, MTYPE_I8):
      TCON_I8(r) = R16_To_I8(TCON_R16(c));
      break;
#endif /* TARG_NEEDS_QUAD_OPS */
    ...
    case FROM_TO(MTYPE_FQ, MTYPE_I1):
      TCON_v0(r) = (INT32) R16_To_F8(TCON_R16(c));
      break;
#endif
    ...
    case FROM_TO(MTYPE_FQ, MTYPE_U8):
      TCON_U8(r) = R16_To_U8(TCON_R16(c));
      break;
#endif
    ...
    case FROM_TO(MTYPE_FQ, MTYPE_U1):
      TCON_u0(r) = (UINT32) R16_To_F8(TCON_R16(c));
      break;
#endif
 ...
 /* Do this the right way     * ((double *) &TCON_v0(c)) = atof(str); */
	...
	if (*sstr == 'q' || *sstr == 'Q') {
	  *sstr='E';
      ...
      TCON_R16(c) = F8_To_R16(atof(str));
      // WAS:  TCON_R16(c) = RQ_To_R16(__c_a_to_q(str, &err));
      break;
...
#define TPB_SIZE 8
	...
	*re = 'd';
	...
	QUAD_TYPE q = TCON_R16(c);
#ifdef EMULATE_QUAD
	q = R16_To_F10(q);
#endif
	if (fmt == NULL) fmt = "%#21.20Lg";
	sprintf(r, fmt, R16_To_RLD(q));
	// if (fmt == NULL) fmt = "%#21.20Lg";
	...
	*re = 'd';
    ...
    case MTYPE_CQ:
      {
	// Convert 128-bit quad host 80-bit long double for printing
	QUAD_TYPE q0 = TCON_R16(c);
	QUAD_TYPE q1 = TCON_R16(c);
#ifdef EMULATE_QUAD
	q0 = R16_To_F10(q0);
	q1 = R16_To_F10(q1);
#endif
	if (fmt == NULL) fmt = "%#21.20Lg, %#21.20Lg";
	sprintf(r, fmt, R16_To_RLD(q0), R16_To_RLD(q1));
#if !(defined(FRONT_END_C) || defined(FRONT_END_CPLUSPLUS))
	if (re = strchr(r, 'e'))
	  *re = 'd';
	if (re = strrchr(r, 'e'))
...
Host_To_Targ_UV( TYPE_ID ty)
{
  ...
  switch (ty) {
   case MTYPE_F4:
     TCON_v0(c)= 0xfffa5a5a;	// 32-bit Signalling NaN
     break;
   case MTYPE_F8:
     TCON_v0(c)= 0xfffa5a5a;	// 64-bit Signalling NaN
...
#ifdef KEY // bug 6429 10760: Mimic the code generated in emulate.cxx
      if (TCON_R4(t) < (1<<23))
#else
...
Create_Simd_Const (TYPE_ID ty, TCON t)
{
  ...
  switch (ty) {
  case MTYPE_V8I4:
    FmtAssert(FALSE, ("Create_Simd_Const: Shouldn't generate V8I4 constant"));
    // If the above assertion proves incorrect, fall through to V8F4 case.
  case MTYPE_V8F4:
    TCON_clear(c);
    TCON_ty(c) = ty;
