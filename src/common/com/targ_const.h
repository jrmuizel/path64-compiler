...
/* On x86, quad is 80-bit precision float. */
...
/* Define 128-bit floating point type as INT32[4] to have alignment 4,
 * rather than 16, so that TCON requires less memory. (14927) */
typedef struct { INT32 qval[4]; } F16_TYPE;
...
inline F16_TYPE
TCON_f16val (const TCON& tcon)		{ return tcon.vals.f16val; }
inline mUINT32
...
extern TCON Host_To_Targ_F16   ( F16_TYPE fvalue );
#ifdef KEY
...
extern F16_TYPE Targ_To_Host_F16 ( TCON fvalue );
...
extern TCON Host_To_Targ_Complex_F16 ( F16_TYPE real, F16_TYPE imag );
