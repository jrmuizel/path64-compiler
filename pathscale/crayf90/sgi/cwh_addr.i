...
/* Dummy procedure is marked with ST_is_value_parm(). To distinguish it
 * from a dummy variable with the "value" attribute, must examine the type */
#define PROC_BY_VALUE(t) ((TY_kind(t) == KIND_SCALAR) || \
