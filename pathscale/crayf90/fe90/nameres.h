...
long	obj_to_attr[Obj_Done]	=	{
	...
	/*	*(*) is	what makes an assumed-size character pointer    */
        ...
        (
#ifdef KEY /* Bug 10475 */
	 /* Can't support this because our character pointer doesn't have
	  * extra field to hold length */
	 (1 << Attr_Assumed_Type_Ch) |	(1 << Attr_Parameter) |
#else /* Bug 10475 */
	 (0 << Attr_Assumed_Type_Ch) |	(1 << Attr_Parameter) |
#endif /* Bug 10475 */
...
long	attr_msg_num[Obj_Done] [Attr_Done]	= {
...
#ifdef KEY /* Bug 6845 */
	    0,	/* Obj_Assum_Type_Ch	 	Attr_Allocatable        */
#else /* KEY Bug 6845 */
	...
	,   0	/* Obj_Assum_Type_Ch	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Expl_Shp_Arr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Assum_Size_Arr	Attr_Protected			*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Defrd_Shp_Arr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Assum_Shp_Arr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	{
#ifdef KEY /* Bug 6845 */
	    0,	/* Obj_Allocatable		Attr_Assumed_Type_Ch	*/
#else /* KEY Bug 6845 */
	...
	,   0	/* Obj_Allocatable	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	/*********************	Obj_Protected	***************************/
	/* The protected statement may only be in the scoping unit of a	  */
	/* module.	Each use-name must be a named variable not in     */
	/* common or a procedure pointer.                		  */
	/******************************************************************/

	{   0,	/* Obj_Protected		Attr_Assumed_Type_Ch	*/
	    0,	/* Obj_Protected		Attr_Dimension		*/
	    0,	/* Obj_Protected		Attr_Explicit_Shp_Arr	*/
	    0,	/* Obj_Protected		Attr_Assumed_Size_Arr	*/
	    0,	/* Obj_Protected		Attr_Deferred_Shp_Arr	*/
	    0,	/* Obj_Protected		Attr_Assumed_Shp_Arr	*/
	    0,	/* Obj_Protected		Attr_Allocatable	*/
	  550,	/* Obj_Protected		Attr_Parameter		*/
	    0,	/* Obj_Protected		Attr_Intent		*/
	    0,	/* Obj_Protected		Attr_Optional		*/
	    0,	/* Obj_Protected		Attr_Private		*/
	    0,	/* Obj_Protected		Attr_Public		*/
	    0,	/* Obj_Protected		Attr_Target		*/
	    0,	/* Obj_Protected		Attr_Equivalence	*/
	    0,	/* Obj_Protected		Attr_Save		*/
	    0,	/* Obj_Protected		Attr_Pointer		*/
	  550,	/* Obj_Protected		Attr_External		*/
	  550,	/* Obj_Protected		Attr_Intrinsic		*/
	    0,	/* Obj_Protected		Attr_Data_Init		*/
	    0,	/* Obj_Protected		Attr_Type		*/
	    0,	/* Obj_Protected		Attr_Co_Array		*/
	    0,	/* Obj_Protected		Attr_Automatic		*/
	    0	/* Obj_Protected		Attr_Volatile		*/
	,   0	/* Obj_Protected	 	Attr_Bind		*/
	,   0	/* Obj_Protected	 	Attr_Value		*/
	,   0	/* Obj_Protected	 	Attr_Protected		*/
	},
#endif /* KEY Bug 14150, 5091 */
	...
	, 550	/* Obj_Constant		 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Automatic	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 550	/* Obj_Dcl_Extern	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 550	/* Obj_Dcl_Intrin	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	...
	,   0	/* Obj_Data_Init	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Copy_Assumed_Shape	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Auxiliary	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Vfunction	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_No_Side_Effects	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Symmetric	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Align_Symbol	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Section_Gp	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Section_Non_Gp	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Ignore_TKR	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Optional_Dir	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Cri_Pointee	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
...

	{
	  ...
	  /* Can't support this because our character pointer doesn't have
	   * extra field to hold length */
	  552,	/* Obj_Cri_Ch_Pointee		Attr_Assumed_Type_Ch	*/
#else /* Bug 10475 */
...
# endif
	...
	,   0	/* Obj_Cri_Ch_Pointee	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Ntry_Func_Result	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Dummy_Arg	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Common_Obj	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Namelist_Obj	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
...
#ifdef KEY /* Bug 14150, 5091 */
	,   0	/* Obj_Module_Proc	 	Attr_Bind		*/
	, 552	/* Obj_Module_Proc	 	Attr_Value		*/
	, 552	/* Obj_Module_Proc	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Derived_Type	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Generic_Interface 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Namelist_Grp	  	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Stmt_Func	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Construct	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Entry_Func	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Entry_Subr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Intern_Func	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Intern_Subr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Module_Func		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 552	/* Obj_Module_Subr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Sf_Actual_Arg	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Var_Len_Ch	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Var_Len_Arr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Sym_Constant_Arr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 550	/* Obj_Interface_Func	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 608	/* Obj_Interface_Subr	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 628	/* Obj_Use_Extern_Func	 	Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 633	/* Obj_Use_Extern_Subr		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Use_In_Expr		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 644	/* Obj_Use_Derived_Type		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	,   0	/* Obj_Use_Spec_Expr		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	},
	...
	, 0	/* Obj_Use_Init_Expr		Attr_Protected		*/
#endif /* KEY Bug 14150, 5091 */
	}
};
...
long	dir_msg_num[Obj_Done] [Dir_Done]	= {
	...
	{   0,	/* Obj_Protected		Dir_Auxiliary		*/
	    0,	/* Obj_Protected		Dir_Vfunction		*/
	    0, 	/* Obj_Protected		Dir_No_Side_Effects	*/
	    0,	/* Obj_Protected		Dir_Inline		*/
	    0,	/* Obj_Protected		Dir_Symmetric		*/
	    0,	/* Obj_Protected		Dir_Copy_Assumed_Shape	*/
	    0,	/* Obj_Protected		Dir_Align_Symbol	*/
	    0,	/* Obj_Protected		Dir_Fill_Symbol		*/
	    0,	/* Obj_Protected		Dir_Section_Gp		*/
	    0,	/* Obj_Protected		Dir_Section_Non_Gp	*/
	    0,	/* Obj_Protected		Dir_Ignore_TKR		*/
	    0,	/* Obj_Protected		Dir_Optional		*/
	    0,	/* Obj_Protected		Dir_Ipa			*/
	    0 	/* Obj_Protected		Dir_Name		*/
	},
#endif /* KEY Bug 14150, 5091 */
...
# endif
	...
	{   0,	/* Obj_Protected		Name_Variable		*/
	  551,	/* Obj_Protected		Name_Common_Obj		*/
	    0,	/* Obj_Protected		Name_Cri_Pointer	*/
	    0,	/* Obj_Protected		Name_Cri_Pointee	*/
	    0,	/* Obj_Protected		Name_Cri_Ch_Pointee	*/
	  551,	/* Obj_Protected		Name_Func_Result	*/
	  551,	/* Obj_Protected		Name_Dummy_Arg		*/
	  551,	/* Obj_Protected		Name_Module_Proc	*/
	  551,	/* Obj_Protected		Name_Derived_Type	*/
	  551,	/* Obj_Protected		Name_Generic_Interface	*/
	  551,	/* Obj_Protected		Name_Namelist_Group	*/
	    0,	/* Obj_Protected		Name_Namelist_Group_Obj	*/
	  551,	/* Obj_Protected		Name_Statement_Func	*/
	  551,	/* Obj_Protected		Name_Construct		*/
	  551,	/* Obj_Protected		Name_Intrinsic_Func	*/
	  551,	/* Obj_Protected		Name_Intrinsic_Subr	*/
	  551,	/* Obj_Protected		Name_Module		*/
	  551,	/* Obj_Protected		Name_Blockdata		*/
	  551,	/* Obj_Protected		Name_Program		*/
	  551,	/* Obj_Protected		Name_Function		*/
	  551,	/* Obj_Protected		Name_Curr_Func		*/
	  551, 	/* Obj_Protected		Name_Curr_Subr		*/
	  551,	/* Obj_Protected		Name_Internal_Func	*/
	  551	/* Obj_Protected		Name_Internal_Subr	*/
	},
#endif /* KEY Bug 14150, 5091 */
...
long	other_msg_num[Obj_Done] [Other_Done]	= {
	...
	{   0,	/* Obj_Protected		Other_Var_Len_Ch	*/
	    0,	/* Obj_Protected		Other_Var_Len_Arr	*/
	  566,	/* Obj_Protected		Other_Expl_Interface	*/
	    0,	/* Obj_Protected		Other_Use_Func		*/
	  574,	/* Obj_Protected		Other_Use_Subr		*/
	    0,	/* Obj_Protected		Other_Use_Variable	*/
	    0,	/* Obj_Protected		Other_Use_Dummy_Arg	*/
	  920,	/* Obj_Protected		Other_Host_Assoc	*/
	    0, 	/* Obj_Protected		Other_Use_Assoc		*/
	    0, 	/* Obj_Protected		Other_Use_Char_Rslt	*/
	  486,	/* Obj_Protected		Other_Not_Visible	*/
	 1134	/* Obj_Protected		Other_Npes		*/
	},
#endif /* KEY Bug 14150, 5091 */
