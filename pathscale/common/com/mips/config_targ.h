 ...
 * $Source: common/com/mips/SCCS/s.config_targ.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_targ_rcs_id = "$Source: common/com/mips/SCCS/s.config_targ.h $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
...
#define Is_Target_Mips5kf() (Target == TARGET_mips5kf)
#define Is_Target_twc9a() (Target == TARGET_twc9a)
