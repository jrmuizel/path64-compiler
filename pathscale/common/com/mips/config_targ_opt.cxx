 ...
 * ====================================================================
 *
 * $Source: common/com/mips/SCCS/s.config_targ_opt.cxx $
 *
 * Revision history:
...
BOOL Sext_Allowed = TRUE;	/* Use sll r2,r1,0 for 32-bit sign extend */
...
static OPTION_DESC Options_TARG[] = {
  ...
  { OVK_BOOL,	OV_INTERNAL,	FALSE, "slow_cvtdl", "",
    ...
    "" },
  { OVK_BOOL,	OV_VISIBLE,	FALSE, "sext",		"",
    0, 0, 0,	&Sext_Allowed,	NULL,
    "Specify whether to use SLL for 32-bit sign extensions" },
