...
//#endif
  ...
  5,  /* Full_unrolling */
#elif defined(KEY)
  5, /* bug 14687: enable Full_unrolling for MIPS */
#else
  0,            /* Full_unrolling */
#endif
#ifdef TARG_MIPS
...
LNO_FLAGS Initial_LNO = {
  ...
  FALSE,	/* Vintr_Verbose */
#ifdef TARG_MIPS
  0,		/* Run_simd: Disable simd vectorization by default */
#else
  1,		/* Run_simd */
#endif
  TRUE,         /* Run_simd_set */
...
#ifdef TARG_MIPS
  LNOPT_BOOL ( "indexed_load",          NULL,   Indexed_Load),
#endif

#ifdef KEY
  LNOPT_BOOL ( "full_unroll_aggressive",     NULL,   Full_Unroll_Aggressive),
  LNOPT_U32  ( "full_unroll_size", 	NULL,   
	       2000,0,50000,Full_unrolling_loop_size_limit),
