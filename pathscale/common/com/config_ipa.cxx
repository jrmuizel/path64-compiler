...
#if defined(KEY) && !defined(ARCH_MIPS)
UINT32	IPA_Max_Jobs = 1;	/* disable concurrent backend compilations */
#else
/* sicortex 7970: concurrent backend compilations on mips nodes */
...
UINT32 IPA_Icall_Min_Freq = DEFAULT_ICALL_MIN_FREQ; // Min freq for icall opt
                                                    // used in IPL.
BOOL IPA_Enable_Source_PU_Order = FALSE;/* maintain source-code PU order */
UINT32 IPA_Enable_Struct_Opt = 1;	/* will be converted to BOOL */
UINT32 IPA_Update_Struct = 0;		/* temporary, should be removed */
BOOL IPA_Enable_Debug = FALSE;		/* debug support needed under -g */
#else
...
*/
    ...
    { OVK_BOOL, OV_INTERNAL,	FALSE, "debug",  "",
	  0, 0, 0,		&IPA_Enable_Debug, NULL,
	  "Enable debugging support under IPA"},
#endif // KEY
