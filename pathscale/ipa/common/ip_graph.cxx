 ...
 * $Source: /home/bos/bk/kpro64-pending/ipa/common/SCCS/s.ip_graph.cxx $
 *
 * Revision history:
...
GRAPH::Build()
{
  ...
  if (vmax != 0) {
    ...
    memset(v, 0, sizeof(GRAPH::NODE_TYPE) * vmax);
  }
  ...
  if (emax != 0) {
    ...
    memset(e, 0, sizeof(GRAPH::EDGE_TYPE) * emax);
  }
...
Depth_First_Ordering ( GRAPH *g, MEM_POOL* m )
{
  ...
  memset ( visit, 0, sizeof(mBOOL)*vertex_max );
